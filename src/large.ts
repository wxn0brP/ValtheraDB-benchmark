...
export async function benchmarkLarge(
	...
	results.push(
		await bench("find-paginated-large", () =>
			col.find(
				{},
				{
					limit: 100,
	...
	results.push(
		await bench("update-search-large", () =>
			col.update(
				{
					$lt: {
						views: 10,
	...
	results.push(
		await bench("remove-search-large", () =>
			col.remove({
				$gt: {
					views: 9995,
				},
