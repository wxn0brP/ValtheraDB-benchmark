...
export async function benchmarkSmall(col: Collection): Promise<BenchResult[]> {
	...
	results.push(
		await bench("find-paginated-small", () =>
			col.find(
				{},
				{
					limit: 100,
	...
	results.push(
		await bench("update-search-small", () =>
			col.update(
				{
					isActive: false,
				},
	...
	results.push(
		await bench("remove-search-small", () =>
			col.remove({
				$lt: {
					age: 25,
				},
